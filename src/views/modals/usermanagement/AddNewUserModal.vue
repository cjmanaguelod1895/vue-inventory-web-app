          ...
          <div class="row">
            <div class="col-md-4">
              <div :class="{
                ...
                <input v-validate="'required'" name="name" v-model="userInfo.name" type="text" class="form-control" id="name" />
                 <label
                        id="name-error"
            ...
            <div class="col-md-4">
              <div  :class="{
                ...
                <label for="company_Name" class="bmd-label-floating"
                  >Company Name</label
                >
                <input type="text" v-validate="'required'" v-model="userInfo.company_Name" name="company_Name" class="form-control" id="company_Name" />
                <label
                        id="name-error"
            ...
            <div class="col-md-4">
              <div  :class="{
                ...
                <label for="email" class="bmd-label-floating"
                  >Email Address</label
                >
                <input type="email" v-validate="'required|email'" v-model="userInfo.email" class="form-control" id="email" name="email" />
                 <label
                        id="email-error"
          ...
          <div class="row">
            <div class="col-md-4">
              <div :class="{
                ...
                <input type="number" v-validate="'required|numeric'" v-model="userInfo.phone"  class="form-control" id="phone" name="phone" />
                  <label
                        id="phone-error"
            ...
            <div class="col-md-4">
              <div class="form-group bmd-form-group is-focused" style="margin-top: 2px">
                <label  for="role" class="bmd-label-floating">Role</label>
                <select class="form-control" id="role">
                  <!-- <option value="0" selected disabled>Select Role</option> -->
                  <option v-model="userInfo.role_id" v-for="(role, id) in roles" :key="role.id"  :value="role.id">
                    {{ role.name }}
                  </option>
                </select>
              </div>
            ...
            <div class="col-md-4">
              <div class="form-check mr-auto" style="margin-top: 25px;">
                      <label class="form-check-label">
                        <input class="form-check-input" type="checkbox" id="is_Active" v-model="userInfo.is_Active" checked required="" aria-required="true"> Active
           ...
           <div class="row">
            <div class="col-md-4">
              <div :class="{
                ...
                <input type="text" v-validate="'required'" v-model="userInfo.username" class="form-control" id="username" name="username" />
                  <label
                        id="username-error"
             ...
             <div class="col-md-4">
              <div :class="{
                ...
                <input type="password"  v-validate="'required'" v-model="userInfo.password"  class="form-control" id="password" name="password" />
              </div>
               <label
                        id="password-error"
        ...
        <div class="modal-footer">
            <div class="loader" v-show="isFormSubmitted"></div>
                    <button class="btn btn-info btn-round"
                     ...
                     style="background:linear-gradient(60deg, #0b52b5, #8e24aa)">Submit<div class="ripple-container"></div></button>
          <button
            type="button"
